...
export const createPlanSchema = z.object({
    ...
    duration_description: z.string("A descrição da duração do plano é obrigatória").optional(),
    features: z.array(z.string("Cada feature do plano é obrigatória")).optional(),
    shortcut: z.string("O atalho do plano é obrigatório").optional()
});
